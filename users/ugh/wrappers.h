...
#define _________________QWERTY_L2_________________       LGUI_T(KC_A),    LALT_T(KC_S),    LCTL_T(KC_D),    LT(_COMMANDS, KC_F),    KC_G
#define _________________QWERTY_L3_________________       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B

#define _________________QWERTY_R1_________________       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P
#define _________________QWERTY_R2_________________       KC_H,    LT(_MEDIA, KC_J),    LCTL_T(KC_K),    LALT_T(KC_L),    LGUI_T(KC_SCLN)
...
// NUMPAD Layer
#define _________________NUMPD_R1__________________       XXX,  KC_7,   KC_8,    KC_9,   KC_MINS
#define _________________NUMPD_R2__________________       XXX,  KC_4,   KC_5,    KC_6,   KC_DOT
#define _________________NUMPD_R3__________________       XXX,  KC_1,   KC_2,    KC_3,   KC_ENT
